...
if(strpos($_SERVER["SCRIPT_NAME"], "aa-test")||strpos($_SERVER["SCRIPT_NAME"], "dev-pesy") ) {
	$CONF_NAME_SQL = "socialsp2_test";
}	

// definition of credentials - db access
...
// test version for pesy  http://www.socialsprinters.cz/dev-pesy/
} elseif (strpos($_SERVER["PHP_SELF"], "dev-pesy") !== false) {
  // setting for develop on localhost
  if (strpos($_SERVER["HTTP_HOST"], 'localhost') !== false) {
    $CONF_BASE_DIR = $CONF_BASE_SSP_DIR = "../";
    $CONF_BASE_SSP = "https://x51.cz/apps/socialssprinters-test/"; // SSL verze
    $CONF_BASE = "http://".$_SERVER["HTTP_HOST"]."/x51/dev-pesy/aa/";
    $CONF_BASE_HOME = "http://".$_SERVER["HTTP_HOST"]."/";
    $CONF_STATIC["app_id"] = '892552947456114';
    $CONF_STATIC["app_secret"] = '5ce56e10c46e7543889e230c96ac9ad2';
    $CONF_XTRA["wkhtmltopdf"] = "/web/www.socialsprinters.cz/aa-test/wkhtmltopdf-amd64";
  } else {
    $CONF_BASE_DIR = $CONF_BASE_SSP_DIR = "/web/www.socialsprinters.cz/dev-pesy/aa/";
  //	$CONF_BASE_SSP_DIR = "/web/x51.cz/apps/socialssprinters/"; // SYMLINK na /web/www.socialsprinters.cz/aa/ !!!
    $CONF_BASE_SSP = "https://x51.cz/apps/socialssprinters-test/"; // SSL verze
    $CONF_BASE = "http://".$_SERVER["HTTP_HOST"]."/dev-pesy/aa/";
    $CONF_BASE_HOME = "http://".$_SERVER["HTTP_HOST"]."/";
    $CONF_STATIC["app_id"] = '892552947456114';
    $CONF_STATIC["app_secret"] = '5ce56e10c46e7543889e230c96ac9ad2';
    $CONF_XTRA["wkhtmltopdf"] = "/web/www.socialsprinters.cz/dev-pesy/aa/wkhtmltopdf-amd64";    
  }
}
