	...
	Plugin.prototype = {
				...
				// Size of the viewport to display image (a resized image will be displayed)
				 ...
				 function build_img_from_file(files) {
					...
					reader.onload = function(e) { 
						_this._create_image_with_datasrc(e.target.result, function(){ $("#popnn").center(); $("#picedit_btn").fadeIn(); $(".picedit_nav_box").fadeIn(); $(".picedit_action_btns ").hide(); $("#tip_before").fadeOut(function(){$("#tip_after").fadeIn()})}, file); 
					};
		...
		set_loading: function (message) {
			if(message && message == 1) {
				return this.set_messagebox(picedit_message_working, false, false);
			}
			else return this.set_messagebox(picedit_message_please_wait, false, false);
		},
		...
		camera_open: function() {
			...
			if (!browserUserMedia) return this.set_messagebox(picedit_message_sorry_no_webRTC);
			var _this = this;
			...
			getUserMedia({
				...
				function(err) {
					return _this.set_messagebox(picedit-message_no_video_source_detected);
				}
			);
		},
		...
		_hideAllNav: function (message) {
			if(message && message == 1) {
				this.set_messagebox(picedit_message_vlozte_obrazek_nebo_fotak);
			}
		...
		_bindControlButtons: function() {
			...
			$(this.element).find(".picedit_control").bind( "click", function() {
				...
				// handle click actions on top nav buttons
					...
					console.log($(this).parent(".picedit_element"));
					console.log($(this).closest(".picedit_element"));
					if($(this).parent(".picedit_element").hasClass("active")) 
						...
						$(this).closest(".picedit_element").removeClass("active"); 
					}
				}
			});
		},
		...
		_formsubmit: function() {
			if(!window.FormData) this.set_messagebox(picedit_message_FormData_API_is_not_supported);
			else {
				var _this = this;
				this.set_loading().delay(200).promise().done(function() {
                    ...
                    request.onprogress = function(e) {
                        ...
                        _this.set_messagebox(picedit_message_please_wait_uploading + ' ' + progress + "% " + picedit_message_please_wait_uploading_done, false, false);
                    };
					...
					request.onload = function(e) {
						if(this.status != 200) {
						    ...
						    else _this.set_messagebox(picedit_message_data_submited);
                        }
		...
		_template: function() {
		  var template = '<div class="picedit_box"> <div class="picedit_message"> <span class="picedit_control ico-picedit-close" data-action="hide_messagebox"></span> <div><\/div><\/div><div class="picedit_nav_box picedit_gray_gradient"> <div class="picedit_pos_elements"><\/div><div class="picedit_nav_elements"><div class="picedit_element"> <span class="picedit_control picedit_action ico-picedit-pencil" title="' + picedit_pen_tool + '"></span> <div class="picedit_control_menu"> <div class="picedit_control_menu_container picedit_tooltip picedit_elm_3"> <label class="picedit_colors"> ' +
'<span title="' + picedit_color_black + '" class="picedit_control picedit_action picedit_black active" data-action="toggle_button" data-variable="pen_color" data-value="black"></span> ' +
'<span title="' + picedit_color_white + '" class="picedit_control picedit_action picedit_white active" data-action="toggle_button" data-variable="pen_color" data-value="white"></span> ' +
'<span title="' + picedit_color_red + '" class="picedit_control picedit_action picedit_red" data-action="toggle_button" data-variable="pen_color" data-value="red"></span> ' + 
'<span title="' + picedit_color_green + '" class="picedit_control picedit_action picedit_green" data-action="toggle_button" data-variable="pen_color" data-value="green"></span> ' + 
'<span title="' + picedit_color_orange + '" class="picedit_control picedit_action picedit_orange" data-action="toggle_button" data-variable="pen_color" data-value="orange"></span> ' +
'<span title="' + picedit_color_blue + '" class="picedit_control picedit_action picedit_blue" data-action="toggle_button" data-variable="pen_color" data-value="blue"></span> '+
'</label> <label><span class="picedit_separator"></span> </label> <label class="picedit_sizes"> ' +
'<span title="' + picedit_pen_large + '" class="picedit_control picedit_action picedit_large" data-action="toggle_button" data-variable="pen_size" data-value="16"></span> ' +
'<span title="' + picedit_pen_medium + '" class="picedit_control picedit_action picedit_medium" data-action="toggle_button" data-variable="pen_size" data-value="8"></span> ' + 
'<span title="' + picedit_pen_small + '" class="picedit_control picedit_action picedit_small" data-action="toggle_button" data-variable="pen_size" data-value="3"></span> ' + 
'<span title="1px" class="picedit_control picedit_action picedit_1px" data-action="toggle_button" data-variable="pen_size" data-value="1"></span> ' + 
'</label> <\/div><\/div><\/div><div class="picedit_element"><span class="picedit_control picedit_action ico-picedit-insertpicture" title="' + picedit_crop_tool + '" data-action="crop_open"></span> <\/div><div class="picedit_element"> <span class="picedit_control picedit_action ico-picedit-redo" title="' + picedit_rotate_tool + '"></span> <div class="picedit_control_menu"> <div class="picedit_control_menu_container picedit_tooltip picedit_elm_1"> <label> <span>90° </span> <span class="picedit_control picedit_action ico-picedit-redo" data-action="rotate_cw"></span> </label> <label> <span>90° </span> <span class="picedit_control picedit_action ico-picedit-undo" data-action="rotate_ccw"></span> </label> <\/div><\/div><\/div> ' +
// '<div class="picedit_element"> <span class="picedit_control picedit_action ico-picedit-arrow-maximise" title="' + picedit_resize_tool + '"></span> <div class="picedit_control_menu"> <div class="picedit_control_menu_container picedit_tooltip picedit_elm_2"> <label><span class="picedit_control picedit_action ico-picedit-checkmark" data-action="resize_image"></span><span class="picedit_control picedit_action ico-picedit-close" data-action=""></span> </label> <label> <span>' + picedit_width + ' (px)</span> <input type="text" class="picedit_input" data-variable="resize_width" value="0"> </label> <label class="picedit_nomargin"> <span class="picedit_control ico-picedit-link" data-action="toggle_button" data-variable="resize_proportions"></span> </label> <label> <span>' + picedit_height + ' (px)</span> <input type="text" class="picedit_input" data-variable="resize_height" value="0"> </label> <\/div><\/div><\/div>' + 
'</div></div><div class="picedit_canvas_box"><div class="picedit_painter"><canvas></canvas></div><div class="picedit_canvas"><canvas></canvas></div><div class="picedit_action_btns active"> <div class="picedit_control ico-picedit-picture" data-action="load_image"><\/div></div></div><div class="picedit_video"> <video autoplay></video><div class="picedit_video_controls"><span class="picedit_control picedit_action ico-picedit-checkmark" data-action="take_photo"></span><span class="picedit_control picedit_action ico-picedit-close" data-action="camera_close"></span><\/div><\/div><div class="picedit_drag_resize"> <div class="picedit_drag_resize_canvas"></div><div class="picedit_drag_resize_box"><div class="picedit_drag_resize_box_corner_wrap"> <div class="picedit_drag_resize_box_corner"></div></div><div class="picedit_drag_resize_box_elements"><span class="picedit_control picedit_action ico-picedit-checkmark" data-action="crop_image"></span><span class="picedit_control picedit_action ico-picedit-close" data-action="crop_close"></span><\/div><\/div></div></div>';
			var _this = this;
